...
@Component({
  selector: 'app-generation6',
  templateUrl: './generation6.component.html',
  styleUrls: ['./generation6.component.css']
})
export class Generation6Component implements OnInit {
  ...
  ngOnInit(): void {
      this.dataService.getPokemonsbyGen6().subscribe( x=> {this.pokemons=x})
