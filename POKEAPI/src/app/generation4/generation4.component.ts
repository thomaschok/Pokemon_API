...
@Component({
  selector: 'app-generation4',
  templateUrl: './generation4.component.html',
  styleUrls: ['./generation4.component.css']
})

export class Generation4Component implements OnInit {
  ...
  ngOnInit(): void {
      this.dataService.getPokemonsbyGen4().subscribe( x=> {this.pokemons=x})
