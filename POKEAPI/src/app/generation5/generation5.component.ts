...
@Component({
  ...
  templateUrl: './generation5.component.html',
  styleUrls: ['./generation5.component.css']
})
export class Generation5Component implements OnInit {
  ...
  ngOnInit(): void {
      this.dataService.getPokemonsbyGen5().subscribe( x=> {this.pokemons=x})
