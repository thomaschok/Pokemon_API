...
@Component({
  selector: 'app-generation7',
  templateUrl: './generation7.component.html',
  styleUrls: ['./generation7.component.css']
})
export class Generation7Component implements OnInit {
  ...
  ngOnInit(): void {
      this.dataService.getPokemonsbyGen7().subscribe( x=> {this.pokemons=x})
